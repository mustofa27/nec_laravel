...
<!-- Main Stylesheet File -->
  ...
  <script src="{{ asset('xenon/assets/js/jquery-validate/jquery.validate.min.js')}}"></script>
  <script src="{{ asset('xenon/assets/js/inputmask/jquery.inputmask.bundle.js')}}"></script>
  <script src="{{ asset('xenon/assets/js/formwizard/jquery.bootstrap.wizard.min.js')}}"></script>
  <script src="{{ asset('xenon/assets/js/datepicker/bootstrap-datepicker.js')}}"></script>
  <script src="{{ asset('xenon/assets/js/multiselect/js/jquery.multi-select.js')}}"></script>
  <script src="{{ asset('xenon/assets/js/jquery-ui/jquery-ui.min.js')}}"></script>
  <script src="{{ asset('xenon/assets/js/selectboxit/jquery.selectBoxIt.min.js')}}"></script>
